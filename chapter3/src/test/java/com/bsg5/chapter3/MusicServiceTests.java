...
public class MusicServiceTests {
    ...
    public void testSongVoting(MusicService service) {
        reset(service);
    ...
    public void testSongsForArtist(MusicService service) {
        reset(service);
        populateService(service);
    ...
    public void testMatchingArtistNames(MusicService service) {
        reset(service);
        populateService(service);
    ...
    public void testMatchingSongNamesForArtist(MusicService service) {
        reset(service);
        populateService(service);
